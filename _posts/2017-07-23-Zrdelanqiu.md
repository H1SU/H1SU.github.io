...
Zr的篮球是HiSU内唯一不受经典物理以及相对论等因果哲学控制的个体。它基本符合测不准原理：无法同时测定或得知其位置与能量，只能计算出其分布在某位置区域的概率。
据Sr透露，Zr的篮球是HiSU内唯一无法受Sr控制的物体。它的性质基本但并不完全符合量子力学。可以作为研究自然哲学的良好试验资料。
...
Sb的剑当且仅当周围（半径10m内）存在“相伯亦拔剑起舞”的文字或声音[1]时出现在Sb手中[2]，并和Sb一起[3]剑舞,具体运作机理不能用唯物主义哲学原理解释[4]。据Ds分析，剑的出现可能与更深刻的唯心哲学有关[5]。
由于其特殊的出现方式，Sb的剑的相关资料暂缺。但从Sr的观测记录[6]可得知，Sb的剑可能为真正的项伯剑；而关于该剑是从何时开始，从何地，为何由Sb控制的记录已被销毁[7]。
...
以上为KNT在编写该条目时被该物品影响的原稿记录。现KNT已痊愈（一个月前），允许以上记录作为该条目的公开资料保留，并表示其中注有「」的部分节选于FR演讲原文。
正如以上资料所示，FR的讲台-1，对于听过FR的演讲的人有非常严重且持久的洗脑效应。具体特征，详见注释[1]。
...
//那个，KNT，我是Sr。已经从我认识的不愿透露姓名的家里蹲全员口中听说这里的事情了。

KNT：……

//其实是Zr先告诉我的。她说她这周要面基约会，所以这周的葡萄园……

KNT：我TM当初为什么要答应你打工……

//啊……是我刚做出来的一个AI，想借你测评一下。不过既然你这么愿意的话……

KNT：啊？AI？

//还没发布，先借你用一阵。你不是说写百科全书写得思维僵化了吗？
...
KNT：外人？图书馆倒是没发现，如果有动静的话，我也应该察觉到了。监视器……

//一切正常。最近有没有什么奇怪的事情？

KNT：……你刚刚说的AI。

//啊？那个我还在制作中，等过一阵打算先借你用的。不过……感觉这个AI，挺傻的。也可能是太聪明了。

KNT：如果是后者的话那就太可怕了。要不就直接让他傻下去吧，傻点也安全。

//……有道理。最近我是不是有些意志不清啊，总感觉会莫名其妙做一些奇怪的事情。

KNT：你是指中二病吗？

//……那好吧。还有，Sb现在正在一个你能看到的地方向你发送莫尔斯电码，你收着点。
